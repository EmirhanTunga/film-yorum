...
Route::group(['prefix' => 'movies'], function () {
    ...
    Route::post('store', [MovieController::class, 'store'])->name('panel.movies.store');
});
...
Route::group(['prefix' => 'movies'], function () {
    ...
    Route::get('create', [MovieController::class, 'create'])->name('panel.movies.create');
    Route::post('store', [MovieController::class, 'store'])->name('panel.movies.store');
    Route::get('edit/{id}', [MovieController::class, 'edit'])->name('panel.movies.edit');
    Route::post('update/{id}', [MovieController::class, 'update'])->name('panel.movies.update');
    Route::delete('delete/{id}', [MovieController::class, 'destroy'])->name('panel.movies.delete');
});
